...
export const COMMIT_QUALITY_SCORE_REPOSITORY = Symbol(
...
export const COMMIT_FILE_REPOSITORY = Symbol("COMMIT_FILE_REPOSITORY");
export const SYNC_JOB_REPOSITORY = Symbol("SYNC_JOB_REPOSITORY");
export const POLICY_REPOSITORY = Symbol("POLICY_REPOSITORY");
export const GENERATION_HISTORY_REPOSITORY = Symbol(
  "GENERATION_HISTORY_REPOSITORY",
);
export const LLM_API_KEY_REPOSITORY = Symbol("LLM_API_KEY_REPOSITORY");
